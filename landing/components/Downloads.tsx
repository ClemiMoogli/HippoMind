...
const platforms = [
  {
    name: 'mac',
    url: 'https://github.com/ClemiMoogli/hippomind/releases/download/v1.0.5/HippoMind_1.0.5_aarch64_darwin.dmg',
    icon: (
  ...
  {
    name: 'windows',
    url: 'https://github.com/ClemiMoogli/hippomind/releases/download/v1.0.5/HippoMind_1.0.5_x64-setup_windows.exe',
    icon: (
      <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'linux',
    url: 'https://github.com/ClemiMoogli/hippomind/releases/download/v1.0.5/HippoMind_1.0.5_amd64_linux.AppImage',
    icon: (
      <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p className="text-gray-600 dark:text-gray-400">
            Version 1.0.5 • Released November 2025
          </p>
        </motion.div>
      </div>
    </section>
