...
const platforms = [
  {
    name: 'mac',
    url: 'https://github.com/ClemiMoogli/nodeflow/releases/download/v1.0.0/NodeFlow_1.0.0_aarch64.dmg',
    icon: (
  ...
  {
    name: 'windows',
    url: 'https://github.com/ClemiMoogli/nodeflow/releases/download/v1.0.0/NodeFlow_1.0.0_x64-setup.exe',
    icon: (
      <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'linux',
    url: 'https://github.com/ClemiMoogli/nodeflow/releases/download/v1.0.0/NodeFlow_1.0.0_amd64.AppImage',
    icon: (
      <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
